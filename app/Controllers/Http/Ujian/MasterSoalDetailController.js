...
class MasterSoalDetailController {
  ...
  async index({ params, request, response, view }) {
    ...
    const mastersoaldetail = await MasterSoalDetail.query().where('master_soal_id', master_soal_id).orderBy('id', 'asc').fetch()
  ...
  async store({ params, request, response }) {
    const { master_soal_id } = params;
    const { nomor, soal, soal_gambar, pilihan_a, pilihan_a_gambar, pilihan_b, pilihan_b_gambar, pilihan_c, pilihan_c_gambar, pilihan_d, pilihan_d_gambar, pilihan_e, pilihan_e_gambar, jawaban } = request.all()
  ...
  async show({ params, request, response, view }) {
    ...
    data['soal_gambar_path'] = mastersoaldetail.soal_gambar ? Env.get("BASE_URL") + "/api/download/soals/" + mastersoaldetail.soal_gambar : "/"
    data['pilihan_a'] = mastersoaldetail.pilihan_a
    data['pilihan_a_gambar'] = mastersoaldetail.pilihan_a_gambar
    data['pilihan_a_gambar_path'] = mastersoaldetail.pilihan_a_gambar ? Env.get("BASE_URL") + "/api/download/soals/" + mastersoaldetail.pilihan_a_gambar : '/'
    data['pilihan_b'] = mastersoaldetail.pilihan_b;
    data['pilihan_b_gambar'] = mastersoaldetail.pilihan_b_gambar
    data['pilihan_b_gambar_path'] = mastersoaldetail.pilihan_a_gambar ? Env.get("BASE_URL") + "/api/download/soals/" + mastersoaldetail.pilihan_b_gambar : "/"
    data['pilihan_c'] = mastersoaldetail.pilihan_c;
    data['pilihan_c_gambar'] = mastersoaldetail.pilihan_c_gambar
    data['pilihan_c_gambar_path'] = mastersoaldetail.pilihan_c_gambar ? Env.get("BASE_URL") + "/api/download/soals/" + mastersoaldetail.pilihan_c_gambar : "/"
    data['pilihan_d'] = mastersoaldetail.pilihan_d
    data['pilihan_d_gambar'] = mastersoaldetail.pilihan_d_gambar
    data['pilihan_d_gambar_path'] = mastersoaldetail.pilihan_d_gambar ? Env.get("BASE_URL") + "/api/download/soals/" + mastersoaldetail.pilihan_d_gambar : "/"
    data['pilihan_e'] = mastersoaldetail.pilihan_e
    data['pilihan_e_gambar'] = mastersoaldetail.pilihan_e_gambar
    data['pilihan_e_gambar_path'] = mastersoaldetail.pilihan_e_gambar ? Env.get("BASE_URL") + "/api/download/soals/" + mastersoaldetail.pilihan_e_gambar : "/"
  ...
  async fetchSoalDetail({ request, response }) {
    ...
    const msd = await MasterSoalDetail.query().where('master_soal_id', master_soal_id).where('nomor', nomor).first();
    ...
    data['soal_gambar_path'] = msd.soal_gambar ? Env.get("BASE_URL") + "/api/download/soals/" + msd.soal_gambar : "/"

    //gambar pilihan
    data['pilihan_a_gambar'] = msd.pilihan_a_gambar ? true : false;
    data['pilihan_a_gambar_path'] = msd.pilihan_a_gambar ? Env.get('BASE_URL') + "/api/download/soals/" + msd.pilihan_a_gambar : "/"

    data['pilihan_b_gambar'] = msd.pilihan_b_gambar ? true : false;
    data['pilihan_b_gambar_path'] = msd.pilihan_b_gambar ? Env.get('BASE_URL') + "/api/download/soals/" + msd.pilihan_b_gambar : ""

    data['pilihan_c_gambar'] = msd.pilihan_c_gambar ? true : false;
    data['pilihan_c_gambar_path'] = msd.pilihan_c_gambar ? Env.get('BASE_URL') + "/api/download/soals/" + msd.pilihan_c_gambar : "/"
    data['pilihan_d_gambar'] = msd.pilihan_d_gambar ? true : false;
    data['pilihan_d_gambar_path'] = msd.pilihan_d_gambar ? Env.get('BASE_URL') + "/api/download/soals/" + msd.pilihan_d_gambar : "/"
    data['pilihan_e_gambar'] = msd.pilihan_e_gambar ? true : false;
    data['pilihan_e_gambar_path'] = msd.pilihan_e_gambar ? Env.get('BASE_URL') + "/api/download/soals/" + msd.pilihan_e_gambar : "/"
